    ...
    ***************************************************************************** */
    ...
    function (_super) {
      ...
      __proto.onPinchStart = function (e) {
        ...
        this.trigger("pinchStart", __assign({
          datas: this.datas,
    ...
    ***************************************************************************** */
    ...
    function (_super) {
      ...
      function InfiniteViewer(containerElement, viewportElement, options) {
        ...
        _this.options = __assign$1(__assign$1({}, DEFAULT_OPTIONS), options);
      ...
      InfiniteViewer = __decorate$1([Properties(PROPERTIES, function (prototype, property) {
        var attributes = {
          enumerable: true,
          configurable: true,
          get: function () {
    ...
    let LitInfiniteViewer = class LitInfiniteViewer extends LitElement {
      firstUpdated() {
        const options = {};
        ...
        const viewport = this.children[0];
        this.infiniteViewer = new InfiniteViewer(this, viewport, Object.assign({}, options));
    ...
    })], LitInfiniteViewer.prototype, "infiniteViewer", void 0);

    LitInfiniteViewer = __decorate([Properties(PROPERTIES, (prototype, name) => {
      property({
        type: OPTION_TYPES[name]
      })(prototype, name);
    }), customElement("lit-infinite-viewer")], LitInfiniteViewer);
