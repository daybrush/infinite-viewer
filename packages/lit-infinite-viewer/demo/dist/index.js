    ...
    ***************************************************************************** */
    ...
    let LitInfiniteViewer = class LitInfiniteViewer extends LitElement {
      firstUpdated() {
        ...
        const scrollArea = this.shadowRoot.querySelector("div");
        this.infiniteViewer = new InfiniteViewer(this, viewport, Object.assign(Object.assign({}, options), {
          scrollArea
        }));
    ...
    LitInfiniteViewer = __decorate([Properties(PROPERTIES, (prototype, name) => {
     ...
     //# sourceMappingURL=LitInfiniteViewer.js.map
