...
var PROPERTIES = ["margin", "threshold", "zoomOffsetX", "zoomOffsetY", "zoom", "rangeX", "rangeY", "rangeOffsetX", "rangeOffsetY", "usePinch", "pinchThreshold", "maxPinchWheel", "wheelScale", "displayVerticalScroll", "displayHorizontalScroll", "useWheelScroll", "translateZ"];
/**
 * @memberof InfiniteViewer
 */
...
function (_super) {
  ...
  __proto.destroy = function () {
    ...
    utils.removeEvent(containerElement, "tgesturestart", this.onGestureStart);
