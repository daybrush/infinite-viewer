...
var RESTRICT_WRAPPER_CLASS_NAME = "".concat(PREFIX, "restrict-wrapper");
...
function (_super) {
      ...
      if (!isThumb) {
        setTimeout(function () {
          requestAnimationFrame(function () {
            ...
            console.log(_this.scrollSize, pos, delta);
  ...
  __proto.render = function (isDisplay, containerSize, scrollRange) {
    ...
    var display = isDisplay && scrollSizeOffset ? "block" : "none";
...
function (_super) {
  ...
  function InfiniteViewer(_containerElement, viewportElement, options) {
    ...
    _this._restrictWrapperElement = null;
  ...
  __proto.destroy = function () {
    ...
    utils.removeEvent(containerElement, "wheel", this.onWheel);
  ...
  __proto.init = function () {
    ...
    var restrictElement = containerElement.querySelector(".".concat(RESTRICT_WRAPPER_CLASS_NAME));
    ...
    if (!wrapperElement) {
      wrapperElement = document.createElement("div"); // restrictElement = document.createElement("div");
    ...
    if (options.useWheelPinch || options.useWheelScroll) {
      utils.addEvent(containerElement, "wheel", this.onWheel, {
        passive: false
      });
    }
  ...
  __proto.render = function () {
    ...
    this.scrollAreaElement.style.cssText = "width:calc(100% + ".concat(this.getScrollAreaWidth(), "px);") + "height:calc(100% + ".concat(this.getScrollAreaHeight(), "px);"); // const wrapperStyle = this._restrictWrapperElement.style;

    var viewportStyle = this._viewportElement.style; // const restrictOffsetX = containerWidth > rangeX[1] ? containerWidth - rangeX[1]: 0;
