...
var PROPERTIES = ["margin", "threshold", "zoom", "rangeX", "rangeY", "usePinch", "pinchThreshold", "wheelScale"];
/**
 * @memberof InfiniteViewer
 */

var OPTIONS = __spreadArrays(PROPERTIES, ["cspNonce", "scrollArea"]);
var OPTION_TYPES = {
  margin: Number,
  threshold: Number,
  zoom: Number,
...
function (_super) {
  ...
  function InfiniteViewer(container, viewport, options) {
    ...
    _this.onGestureChange = function (e) {
      ...
      if (_this.dragger.isFlag() || !_this.tempScale) {
        _this.tempScale = 0;
        return;
      }
  ...
  __proto.destroy = function () {
    ...
    utils.removeEvent(container, "scroll", this.onScroll);
    utils.removeEvent(container, "wheel", this.onWheel);
    utils.removeEvent(container, "gesturestart", this.onGestureStart);
    utils.removeEvent(container, "gesturechange", this.onGestureChange);
    this.dragger = null;
  ...
  __proto.init = function () {
    ...
    utils.addEvent(container, "wheel", this.onWheel, {
      passive: false
    });
    utils.addEvent(container, "gesturestart", this.onGestureStart, {
      passive: false
    });
    utils.addEvent(container, "gesturechange", this.onGestureChange, {
      passive: false
    });
    this.render();
