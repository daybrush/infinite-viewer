...
var PROPERTIES = ["margin", "threshold", "zoomOffsetX", "zoomOffsetY", "zoom", "zoomX", "zoomY", "rangeX", "rangeY", "rangeOffsetX", "rangeOffsetY", "usePinch", "useMouseDrag", "pinchThreshold", "maxPinchWheel", "wheelScale", "displayVerticalScroll", "displayHorizontalScroll", "translateZ", "useAutoZoom", "wheelPinchKey", "zoomRange", "pinchDirection", "useOverflowScroll"];
/**
 * @memberof InfiniteViewer
 */
...
function (_super) {
  ...
  function ScrollBar(containerElement, type, container) {
    ...
    var doc = utils.getDocument(containerElement);
    var thumbElement;
    ...
    _this.gesto = new Gesto(barElement, {
      container: utils.getWindow(doc)
    }).on("dragStart", function (e) {
      return _this._onDragStart(e);
    }).on("drag", function (e) {
      return _this._onDrag(e);
    });
    utils.addEvent(_this.barElement, "wheel", _this._onWheel, {
      passive: false
    });
    return _this;
  }
  ...
  __proto.render = function (isDisplay, pos, size, scrollSize) {
    ...
    var opacity = isDisplay && utils.throttle(scrollSize - size, 0.001) > 0 ? 1 : 0;
  ...
  __proto.destroy = function () {
    utils.removeEvent(this.barElement, "wheel", this._onWheel);
    this.gesto.off();
    this.off();
  };
...
function (_super) {
  ...
  function InfiniteViewer(_containerElement, viewportElement, options) {
    ...
    if (utils.isNode(viewportElement)) {
  ...
  __proto.init = function () {
    ...
    var doc = utils.getDocument(containerElement);
    var win = utils.getWindow(containerElement); // vanilla
    ...
    if (wheelContainerOption) {
      ...
      } else if (utils.isNode(wheelContainerOption)) {
    ...
    this.gesto = new Gesto(containerElement, {
      container: utils.getWindow(containerElement),
      events: ["touch", "mouse"],
    ...
    if (options.useResizeObserver) {
      ...
      utils.addEvent(win, "resize", this.resize);

      this._onDestroys.push(function () {
        utils.removeEvent(win, "resize", _this.resize);
      });
    }
