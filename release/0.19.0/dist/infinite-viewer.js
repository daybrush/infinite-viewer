    ...
    function (_super) {
      ...
      __proto._setZoom = function (zoom, zoomBase) {
        ...
        if (zoomBase === "viewport") {
          zoomX = (-scrollLeft + convertUnitSize("".concat(zoomOffsetX), this.viewportWidth)) * prevZoom;
          zoomY = (-scrollTop + convertUnitSize("".concat(zoomOffsetY), this.viewportHeight)) * prevZoom;
        } else {
          zoomX = convertUnitSize("".concat(zoomOffsetX), containerWidth);
          zoomY = convertUnitSize("".concat(zoomOffsetY), containerHeight);
        }
