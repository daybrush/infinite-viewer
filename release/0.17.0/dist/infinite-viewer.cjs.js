...
function (_super) {
  ...
  __proto._startZoomAnimation = function (dest, options) {
    ...
    startAnimation(function (distRatio) {
      return _this._setZoom(_this.zoom + dest * distRatio);
    }, function (next) {
  ...
  __proto._startScrollAnimation = function (dest, options) {
    ...
    var easing = options.easing || DEFAULT_EASING;
    startAnimation(function (distRatio) {
      return _this._scrollBy(dest[0] * distRatio, dest[1] * distRatio);
    }, function (next) {
  ...
  __proto._setZoom = function (zoom) {
    var _a = this,
        containerWidth = _a.containerWidth,
        containerHeight = _a.containerHeight,
        prevZoom = _a.zoom,
    ...
    var zoomX = utils.convertUnitSize("".concat(zoomOffsetX), containerWidth);
    var zoomY = utils.convertUnitSize("".concat(zoomOffsetY), containerHeight);
  ...
  __proto._scrollBy = function (deltaX, deltaY) {
    return this._scrollTo(this.getScrollLeft() + deltaX, this.getScrollTop() + deltaY);
  };

  __proto._scrollTo = function (x, y) {
    var _this = this;
    ...
    this._scrollToType("horizontal", x);

    this._scrollToType("vertical", y);
  ...
  __proto._scrollToType = function (type, coord) {
