...
class NgxInfiniteViewerComponent extends NgxInfiniteViewerInterface {
    ...
    ngAfterViewInit() {
        ...
        this.infiniteViewer = new VanillaInfiniteViewer(this.containerElementRef.nativeElement, this.scrollAreaElementRef.nativeElement.nextElementSibling, Object.assign(Object.assign({}, options), { wrapperElement: this.wrapperElementRef.nativeElement, scrollAreaElement: this.scrollAreaElementRef.nativeElement, horizontalScrollElement: this.horizontalScrollElementRef.nativeElement, verticalScrollElement: this.verticalScrollElementRef.nativeElement }));
