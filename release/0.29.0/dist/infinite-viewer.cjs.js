...
function (_super) {
  ...
  __proto.setTo = function (options) {
    ...
    var nextZoomX = utils.between(zoomX, zoomRangeX[0], zoomRangeX[1]);
    var nextZoomY = utils.between(zoomY, zoomRangeY[0], zoomRangeY[1]);
  ...
  __proto._triggerPinch = function (event) {
    ...
    this.trigger("pinch", __assign(__assign({}, event), {
      ...
      zoomX: utils.between(zoomX, zoomRangeX[0], zoomRangeX[1]),
      zoomY: utils.between(zoomY, zoomRangeY[0], zoomRangeY[1]),
      ratioX: ratioX,
      ratioY: ratioY
    }));
  };
