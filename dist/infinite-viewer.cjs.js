...
var PROPERTIES = ["margin", "threshold", "zoom", "rangeX", "rangeY", "usePinch", "pinchThreshold", "wheelScale", "displayVerticalScroll", "displayHorizontalScroll"];
/**
 * @memberof InfiniteViewer
 */
  ...
  function InfiniteViewer(containerElement, viewportElement, options) {
    ...
    _this.onWheel = function (e) {
      ...
      if (ctrlKey) {
        ...
        var scale = Math.max(1 + distance * (_this.options.wheelScale || 0.01), TINY_NUM);
