...
var OPTIONS = __spreadArrays(PROPERTIES, ["useWheel", "useGesture", "cspNonce", "wrapperElement", "scrollAreaElement", "verticalScrollElement", "horizontalScrollElement"]);
/**
 * @memberof InfiniteViewer
 */
...
function (_super) {
  ...
  function InfiniteViewer(containerElement, viewportElement, options) {
    ...
    _this.onWheel = function (e) {
      ...
      var isKeydown = e[_this.wheelPinchKey + "Key"];
  ...
  __proto.destroy = function () {
    ...
    utils.removeEvent(window, "resize", this.resize);
    utils.removeEvent(this.wrapperElement, "scroll", this.onScroll);
  ...
  __proto.setZoom = function (zoom, isSetter) {
    ...
    var zoomX = utils.convertUnitSize("" + zoomOffsetX, containerWidth);
    var zoomY = utils.convertUnitSize("" + zoomOffsetY, containerHeight);
  ...
  __proto.init = function () {
    ...
    utils.addEvent(wrapperElement, "scroll", this.onScroll);
  ...
  __proto._triggerPinch = function (event) {
    ...
    var _a = this._tempRect,
        ...
        width = _a.width,
        height = _a.height;
    var ratioX = (clientX - left) / width;
    var ratioY = (clientY - top) / height;
