...
var PROPERTIES = ["margin", "threshold", "zoomOffsetX", "zoomOffsetY", "zoom", "rangeX", "rangeY", "usePinch", "pinchThreshold", "wheelScale", "displayVerticalScroll", "displayHorizontalScroll", "useForceWheel", "translateZ"];
/**
 * @memberof InfiniteViewer
 */
...
function (_super) {
  ...
  __proto.init = function () {
    ...
    utils.addClass(containerElement, CLASS_NAME); // vanilla
